...
/**
 * Stage II: every editorial manuscript collection is editable in Tina.
 * Canonical files remain under manuscript/ — no parallel content tree.
 */
  ...
  schema: {
    collections: [
      ...
      // ── Projects ────────────────────────────────────────────────────
      {
        ...
        ui: {
          router: ({ document }) => {
            // Prefer frontmatter slug when present; fall back to filename.
            const slug =
